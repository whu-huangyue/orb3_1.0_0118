...
int main(int argc, char **argv)
{
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        // string pathCam0 = pathSeq + "/data-cam/cam_left";
        // string pathCam1 = pathSeq + "/data-cam/cam_right";
        // string pathImu = pathSeq + "/data-imu/IMU.csv";

	    // string pathCam0 = pathSeq + "/stereo-frame_left-image_raw";
        // string pathCam1 = pathSeq + "/stereo-frame_right-image_raw";
	    // string pathImu = pathSeq + "/imu.csv";

	    string pathCam0 = pathSeq + "/image_left";
        string pathCam1 = pathSeq + "/image_right";
	    string pathImu = pathSeq + "/imu.csv";
